...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../tatic/css/bootstrap.min.css">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                <div class="ad-auth-content">
                    <form action="/register.do" name="form" method=post>
                        ...
                        <div class="ad-auth-form">
                            <div class="ad-auth-feilds mb-30">
                                <input type="text" placeholder="Enter Name" name="uname" class="ad-input">
                            ...
                            <div class="ad-auth-feilds mb-30">
                                <input type="text" placeholder="Email Address" name="email" class="ad-input">
                                <div class="ad-auth-icon">
                            ...
                            <div class="ad-auth-feilds">
                                <input type="password" placeholder="Password" name="pwd" class="ad-input">
                                <div class="ad-auth-icon">
                        ...
                        <div class="ad-auth-btn">
                            <a href="javascript:form.submit();" class="ad-btn ad-login-member">Sign up</a>
                        </div>
