            ...
            <div class="row">
                ...
                <div class="col-xl-8 col-lg-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="/updaBrd.do">
                                <input name="brdId" value="${brd.brdId}" type="hidden">
                                <input name="stsCd" value="${brd.stsCd}" type="hidden">
                                <div class="row">
                                    <div class="col-xl-12 col-lg-12">
                                        <div class="form-group">
                                            <label  class="col-form-label">公司名称（中文）</label>
                                            <input class="form-control" type="text" name="nameCn" placeholder="" value="${brd.nameCn}">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-xl-12 col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="nameEn" placeholder="" value="${brd.nameEn}">
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="createdBy" placeholder="" id="password-input" value="${brd.createdBy}">
                                </div>

                                <div class="form-group mb-0" style="text-align: center">
                                    <button class="btn btn-primary squer-btn mt-2 mr-2" type="submit">更新</button>
                                </div>
                            </form>
                        </div>
                    </div>
